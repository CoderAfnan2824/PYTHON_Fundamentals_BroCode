...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        image = QLabel("Hello", self)       #create object for label on window object
        image.setFont(QFont("Arial",40))    # change size and font
        image.setGeometry(0,0,500,100)      # set position and dimentions

        image.setStyleSheet("color: blue;"
        ...
        image.setAlignment(Qt.AlignBottom)
        image.setAlignment(Qt.AlignVCenter)
